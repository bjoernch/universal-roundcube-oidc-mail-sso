CREATE TABLE IF NOT EXISTS `{$prefix}oidc_mail_sso_oidc_user` (
...
CREATE TABLE IF NOT EXISTS `{$prefix}oidc_mail_sso_mailbox` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int unsigned DEFAULT NULL,
  `oidc_sub` varchar(191) NOT NULL,
  `email` varchar(320) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `{$prefix}oidc_mail_sso_audit_log` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `{$prefix}oidc_mail_sso_policy` (
...
CREATE TABLE IF NOT EXISTS `{$prefix}oidc_mail_sso_rate_limit` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
